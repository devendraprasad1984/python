...
from collections import namedtuple
n,fields=int(input().strip()), input().split()
marksObj=namedtuple('marksObj',fields)
totalMarks=[int(marksObj(*(input().split())).MARKS) for _ in range(n)]
print("%.2f"%(sum(totalMarks)/len(totalMarks)))
